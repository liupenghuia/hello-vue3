...
// node_modules/@bassist/utils/dist/index.mjs
var b = Object.defineProperty;
var w = (e, i, o) => i in e ? b(e, i, { enumerable: true, configurable: true, writable: true, value: o }) : e[i] = o;
var u = (e, i, o) => (w(e, typeof i != "symbol" ? i + "" : i, o), o);
var E = {
  isSupported: typeof navigator > "u" ? false : !!navigator.clipboard,
  async copy(e) {
    if (!this.isSupported)
      return false;
...
var P = !l;
var L = /iPhone|phone|android|iPod|pad|iPad/i;
function x() {
  return l ? L.test(c()) : false;
}
function B() {
  return l ? !x() : false;
}
var U = /Android/i.test(c());
var Q = /iPhone|iPod|iPad|iOS/i.test(c());
var V = /uni-app|html5plus/.test(c());
var R = /MicroMessenger/i.test(c());
var D = /\sQQ|mqqbrowser|qzone|qqbrowser/i.test(c());
var q = /mqqbrowser|qqbrowser/i.test(c());
var j = /qzone\/.*_qz_([\d.]+)/i.test(c());
var Z = /(weibo).*weibo__([\d.]+)/i.test(c());
var J = /(baiduboxapp)\/([\d.]+)/i.test(c());
function Y(e, { immediate: i } = { immediate: true }) {
  l && (i && window.addEventListener("load", e, false), window.addEventListener(
...
function f(e, i) {
  return M(e) ? Object.prototype.hasOwnProperty.call(e, i) : false;
}
function ee(e) {
...
var z = class {
  ...
  constructor(i) {
    ...
    this.data = {};
    const o = f(p, i);
    this.data = o ? p[i].data : {}, o || (p[i] = this);
  }
  /**
   ...
   */
  getItem(i) {
    return f(this.data, i) ? this.data[i] : null;
  }
  /**
   ...
   */
  removeItem(i) {
    f(this.data, i) && delete this.data[i];
  }
  /**
...
var S = class {
  ...
  constructor(i, o) {
    u(this, "prefix");
    u(this, "storage");
    this.prefix = i, this.storage = l ? window[o] : new z(i);
  }
  /**
   * Read stored data
  ...
  get(i) {
    ...
    if (!o)
      return o;
    try {
      return o === "true" ? true : o === "false" ? false : o === "null" ? null : o === "undefined" ? void 0 : JSON.parse(o);
    } catch {
      return o;
    }
  }
  ...
  set(i, o) {
    try {
      const n = T(o) === "string" ? o : JSON.stringify(o);
      this.storage.setItem(`${this.prefix}-${i}`, n);
    } catch (t) {
      console.log(t);
    }
  }
  ...
  list() {
    ...
    for (let t = 0; t < o; t++) {
      ...
      n != null && n.startsWith(this.prefix) && i.push(n.replace(`${this.prefix}-`, ""));
    }
    return i;
  }
};
...
var g = l ? window.matchMedia("(prefers-color-scheme: dark)") : void 0;
function G() {
  return l ? g.matches : false;
}
var C = l ? window.matchMedia("(prefers-color-scheme: light)") : void 0;
function y() {
  return l ? C.matches : false;
}
function te() {
  if (G())
    return "dark";
...
var _ = l ? window.matchMedia("(orientation: portrait)") : void 0;
function ne() {
  return l ? _.matches : false;
}
var v = l ? window.matchMedia("(orientation: landscape)") : void 0;
function re() {
  return l ? v.matches : false;
}
var ae = class {
  constructor(i) {
    u(this, "mime");
...
function O([e, ...i]) {
  return e ? (e.toLowerCase() + i.join("")).replace(/[-_](\w)/g, (t, n) => n ? n.toUpperCase() : "") : "";
}
function ue(e) {
  return e ? H(O(e)) : "";
}
...
function Me({ primaryKey: e, list: i }) {
...
function pe(e, i) {
  ...
  const o = {};
  for (const t in e)
    f(e, t) && !i.includes(t) && (o[t] = e[t]);
  return o;
}
function he(e, i) {
  const o = new Date(e), t = o.getFullYear(), n = ("0" + (o.getMonth() + 1)).slice(-2), a = ("0" + o.getDate()).slice(-2), r = ("0" + o.getHours()).slice(-2), s = ("0" + o.getMinutes()).slice(-2), d = ("0" + o.getSeconds()).slice(-2);
  return i ? `${t}-${n}-${a}` : `${t}-${n}-${a} ${r}:${s}:${d}`;
}
function ke(e, i = {
  days: "天",
  hours: "小时",
  ...
  const o = Math.floor(e / 1e3), t = Math.floor(o / (3600 * 24)), n = Math.floor(o % (3600 * 24) / 3600), a = Math.floor(o % 3600 / 60), r = Math.floor(o % 60), s = [];
  return t > 0 && s.push(`${t} ${i.days}`), n > 0 && s.push(`${n} ${i.hours}`), a > 0 && s.push(`${a} ${i.minutes}`), r > 0 && s.push(`${r} ${i.seconds}`), s.length === 0 ? `0 ${i.seconds}` : s.join(" ");
}
function A(e) {
  let i = "";
  if (l) {
...
function Ae() {
  const e = K(0, W.length - 1);
  return W[e];
}
function Ke({ type: e, id: i, resource: o }) {
  return new Promise((t, n) => {
    ...
    function a(r) {
      r.addEventListener("load", t), r.addEventListener("error", n), r.addEventListener("abort", n);
    }
    switch (e) {
      case "js": {
        const r = document.createElement("script");
        r.id = i, r.async = true, r.src = o, a(r), document.head.appendChild(r);
        break;
      }
      case "css": {
        const r = document.createElement("link");
        r.id = i, r.rel = "stylesheet", r.href = o, a(r), document.head.appendChild(r);
        break;
      }
      case "style": {
        const r = document.createElement("style");
        r.id = i, a(r), document.head.appendChild(r), r.appendChild(document.createTextNode(o));
        break;
      }
    }
  });
...
function be(e, i) {
  return new Promise((o, t) => {
    ...
    const a = N(e) || i || `jsonp_callback_${F().replace(/-/g, "_")}`;
    window[a] = (k) => {
      try {
        delete window[a];
      } catch {
      ...
      document.body.removeChild(d), o(k);
    };
    const r = e.includes("?") ? "&" : "?", s = e.includes("callback") ? e : e + r + "callback=" + a, d = document.createElement("script");
    d.src = s, d.onerror = t, document.body.appendChild(d);
  });
}
async function we(e) {
  const i = [];
  for (const o in e)
    i.push(
      new Promise((t, n) => {
        const a = new Image();
        a.onload = t, a.onerror = n, a.src = o;
      })
    );
...
function ze(e, i) {
  let o, t = 0;
  return function(...n) {
    const a = Date.now(), r = i - (a - t);
    r <= 0 ? (clearTimeout(o), t = a, e.apply(this, n)) : o || (o = setTimeout(() => {
      t = Date.now(), o = void 0, e.apply(this, n);
    }, r));
  };
}
function ge(e) {
...
var Ne = h("development");
var Fe = h("test");
var $e = h("production");
export {
  ae as FileInfo,
  ie as LocalStorage,
  oe as SessionStorage,
  O as camelCase,
  H as capitalize,
  h as checkRuntimeEnv,
  E as clipboard,
  g as darkMediaQuery,
  xe as debounce,
  ce as ellipsis,
  ...
  pe as excludeFields,
  le as extractNumber,
  We as extractQueryInfo,
  se as formatAmount,
  ke as formatDuration,
  he as formatTime,
  ee as getBytes,
  T as getDataType,
  te as getPrefersColorScheme,
  N as getQuery,
  $ as getRuntimeEnv,
  c as getUserAgent,
  f as hasKey,
  ...
  be as jsonp,
  de as kebabCase,
  v as landscapeMediaQuery,
  C as lightMediaQuery,
  Ke as loadRes,
  L as mobileDevicesRegExp,
  A as parseQuery,
  ue as pascalCase,
  _ as portraitMediaQuery,
  we as preloadImages,
  Te as randomBoolean,
  K as randomNumber,
  F as randomString,
  Ae as randomUserAgent,
  Oe as runtimeEnv,
  Se as shuffle,
  Le as sleep,
  m as sortKeys,
  me as stringifyQuery,
  ze as throttle,
  Me as unique,
  W as userAgents,
  Y as watchResize
};
//# sourceMappingURL=@bassist_utils.js.map
